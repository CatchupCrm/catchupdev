            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">
                    ...
                    <button type="button" class="btn btn-primary"
                            onclick="buyWhiteLabel()">{{ trans('texts.buy_license') }} </button>
                    <button type="button" class="btn btn-primary"
                            onclick="showApplyLicense()">{{ trans('texts.apply_license') }} </button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="whiteLabelLicenseModal" tabindex="-1" role="dialog"
         aria-labelledby="whiteLabelLicenseModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
