    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-padding-right">
            ...
            @if ($companyGateway)
                ...
                {!! Former::populateField('publishable_key', $companyGateway->getPublishableStripeKey() ? str_repeat('*', strlen($companyGateway->getPublishableStripeKey())) : '') !!}
            ...
            @foreach ($gateways as $gateway)
                ...
                <div id="gateway_{{ $gateway->id }}_div" class='gateway-fields' style="display: none">
                    @foreach ($gateway->fields as $field => $details)
                        ...
                        @if ($details && !$companyGateway && !is_array($details))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-8 help-block">
                                <input type="text" class="form-control" onfocus="$(this).select()" readonly
                                       value="{{ URL::to(env('WEBHOOK_PREFIX','').'payment_hook/'.$company->company_key.'/'.GATEWAY_STRIPE) }}">
