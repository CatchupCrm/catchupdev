        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @if (Auth::user()->primaryCompany()->id != Auth::user()->company->id)
                        <center style="font-size:16px;color:#888888;">
                            {{ trans('texts.switch_to_primary', ['name' => Auth::user()->primaryCompany()->getDisplayName()]) }}
                        </center>
                    @else
            ...
            {!! Former::open('settings/company_management') !!}
                                ...
                                <div class="checkbox">
                                    <label for="modules_{{ $value}}">
                                        <input name="modules[]" id="modules_{{ $value}}" type="checkbox"
                                               {{ Auth::user()->company->isModuleEnabled($entityType) ? 'checked="checked"' : '' }} value="{{ $value }}">{{ trans("texts.{$entityType}s") }}
                                    </label>
                                </div>
                            @endforeach
                        </div>
            ...
            {!! Former::open('settings/cancel_company')->addClass('cancel-company') !!}
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"
                                id="confirmCancelModalLabel">{!! trans('texts.cancel_company') !!}</h4>
                        </div>
                        ...
                        <div class="modal-footer" style="margin-top: 0px">
                            ...
                            <button type="button" class="btn btn-danger"
                                    onclick="confirmCancel()">{{ trans('texts.cancel_company') }}</button>
                        </div>
