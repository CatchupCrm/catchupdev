                ...
                <div class="panel-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            ...
                            <li role="presentation"><a href="#header_footer" aria-controls="header_footer" role="tab"
                                                       data-toggle="tab">{{ trans('texts.header_footer') }}</a></li>
                        </ul>
                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="invoice_fields">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'company_fields1', 'fields' => INVOICE_FIELDS_COMPANY])
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'company_fields2', 'fields' => INVOICE_FIELDS_COMPANY])
                                </div>
