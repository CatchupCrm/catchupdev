                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control"
                                   data-bind="value: company_name, valueUpdate: 'afterkeydown', attr: {name: 'bank_companies[' + $index() + '][company_name]'}"/>
                            <input type="text" style="display:none"
                                   data-bind="value: hashed_company_number, attr: {name: 'bank_companies[' + $index() + '][hashed_company_number]'}"/>
                        </td>
