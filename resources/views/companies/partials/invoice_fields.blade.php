...
function ViewModel(data) {
    ...
    self.resetFields = function() {
        ...
        self.company_fields1.removeAll();
        self.company_fields2.removeAll();
    }
    ...
    self.updateSelects = function() {
        var usedFields = [].concat(self.invoice_fields(), self.client_fields(), self.company_fields1(), self.company_fields2());
        var selects = [
            'invoice_fields',
            'client_fields',
            'company_fields1',
