...
class Client extends EntityModel
{
    ...
    public function addContact($data, $isPrimary = false)
    {
        ...
        if ($publicId && $publicId != '-1') {
            ...
            if (isset($data['contact_key']) && $this->company->company_key == env('NINJA_LICENSE_COMPANY_KEY')) {
    ...
    public function getGatewayToken()
    {
        ...
        return CompanyGatewayToken::clientAndGateway($this->id, $companyGateway->id)->first();
    }
