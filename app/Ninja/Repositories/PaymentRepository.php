...
class PaymentRepository extends BaseRepository
{
    ...
    public function find($clientPublicId = null, $filter = null)
    {
        $query = DB::table('payments')
            ...
            ->leftJoin('company_gateways', 'company_gateways.id', '=', 'payments.company_gateway_id')
            ->leftJoin('gateways', 'gateways.id', '=', 'company_gateways.gateway_id')
