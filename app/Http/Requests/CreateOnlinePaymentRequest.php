...
class CreateOnlinePaymentRequest extends Request
{
    ...
    public function sanitize()
    {
        ...
        $invitation = Invitation::with('invoice.invoice_items', 'invoice.client.currency', 'invoice.client.company.currency', 'invoice.client.company.company_gateways.gateway')
